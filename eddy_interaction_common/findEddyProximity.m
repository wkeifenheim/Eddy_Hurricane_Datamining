%Runs over all hurricane timesteps and tries to find an eddy body within
%20km.
%Adapted to work with the common (ESv1/ESv2) eddy files
...
j = find(eddy_track_date_indices.Date(:) == cur_slice);
...
antiCyc = acyc_eddies.combined{j};
cyc = cyc_eddies.combined{j};
