...
f = figure;
set(f,'Name','Translational speeds in 25-50th percentile');

all_eddies = IBTrACS_1992_2010(~isnan(IBTrACS_1992_2010.EddyClass(:)),:);
all_eddies = all_eddies(bitand(all_eddies.Displacement_d1(:) >= disp_25,...
    all_eddies.Displacement_d1(:) < disp_50),:);
...
bound_eddies = bound_eddies(bitand(bound_eddies.Displacement_d1(:) >= disp_25,...
    bound_eddies.Displacement_d1(:) < disp_50),:);
...
outside_eddies = outside_eddies(bitand(outside_eddies.Displacement_d1(:) >= disp_25,...
    outside_eddies.Displacement_d1(:) < disp_50),:);
...
inside_eddies = inside_eddies(bitand(inside_eddies.Displacement_d1(:) >= disp_25,...
    inside_eddies.Displacement_d1(:) < disp_50),:);
