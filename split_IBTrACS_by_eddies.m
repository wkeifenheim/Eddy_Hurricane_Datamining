...
total = size(IBTrACS_1992_2010,1);
for i=1 : size(IBTrACS_1992_2010,1)
    if(isnan(IBTrACS_1992_2010.EddyClass(i)))
        ...
        if(overOcean)
            IBTrACS_miss = [IBTrACS_miss; IBTrACS_1992_2010(i,:)];
    ...
    elseif(IBTrACS_1992_2010.EddyClass(i) == 1) %anticyclonic association
        ...
        if(overOcean)
            IBTrACS_acyc = [IBTrACS_acyc; IBTrACS_1992_2010(i,:)];
    ...
    elseif(IBTrACS_1992_2010.EddyClass(i) == -1) %cyclonic association
        ...
        if(overOcean)
            IBTrACS_cyc = [IBTrACS_cyc; IBTrACS_1992_2010(i,:)];
