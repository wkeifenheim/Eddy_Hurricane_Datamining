...
function plot_projected_path()

load('/project/expeditions/eddies_project_data/hurricane_interaction_data/IBTrACS_1992_2010_bu_all.mat');
...
%     arclength = arclength(2:end);
    ...
    lonouts(lonouts > 10) = lonouts(lonouts > 10) - 360;
